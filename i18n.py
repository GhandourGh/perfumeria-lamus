...
ES = {
    ...
    "Payable": "Por pagar", "Overdue": "Vencido", "All": "Todos", "Expand": "Ver más", "Collapse": "Ver menos",
...
DYNAMIC_PATTERNS = [
    ...
    (re.compile(r"^(\d+) of (\d+) customers owe · (\d+) overdue$"), r"\1 de \2 clientes deben · \3 vencidos"),
    ...
    (re.compile(r"^(\d+) of (\d+) vendors owed · (\d+) overdue$"), r"Se debe a \1 de \2 proveedores · \3 vencidos"),
    ...
    (re.compile(r"^Overdue · (\d+) day$"), r"Vencido · \1 día"),
    (re.compile(r"^Overdue · (\d+) days$"), r"Vencido · \1 días"),
    (re.compile(r"^Overdue by (\d+) day$"), r"Vencido hace \1 día"),
    (re.compile(r"^Overdue by (\d+) days$"), r"Vencido hace \1 días"),
